 ...
 */
trait RestActions{    
    protected function all(Request $request): mixed{
    ...
    protected function get(int $id): mixed{
        return response()->json(self::MODEL::find($id),200);
    }

    protected function create(Request $request): mixed{
    ...
    protected function update(Request $request, int $id): mixed{
        $this->validate($request,self::MODEL::$rules);
